...
// Model Definitions
export const GEMINI_MODEL_STANDARD = "gemini-2.5-flash"; // Standard/Text
export const GEMINI_MODEL_FAST = "gemini-2.5-flash-lite-latest"; // Low latency
export const GEMINI_MODEL_THINKING = "gemini-3-pro-preview"; // High reasoning
export const GEMINI_MODEL_MAPS = "gemini-2.5-flash"; // Maps grounding
export const GEMINI_MODEL_VISION = "gemini-2.5-flash"; // Multimodal
