      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden transform transition-all animate-in fade-in zoom-in duration-300">
        ...
        <div className="p-6">
          <div className="flex flex-col items-center justify-center mb-6 space-y-4">
            <div className="bg-green-100 text-green-800 px-4 py-1 rounded-full text-sm font-semibold border border-green-200">
              Only KSH {PREMIUM_PRICE_KSH} / session
            </div>

            <div className="w-full bg-slate-50 border border-slate-200 rounded-xl p-4 text-center">
              <p className="text-xs text-slate-500 uppercase font-bold tracking-wider mb-1">Pay to Pochi la Biashara</p>
              <div className="text-2xl font-mono font-bold text-slate-800 tracking-tight">0757 634590</div>
          ...
          <form onSubmit={handlePayment} className="space-y-4">
            <div>
              <label className="block text-sm font-medium text-slate-700 mb-1">Confirm M-PESA Phone Number</label>
              <div className="relative">
                <span className="absolute left-3 top-2.5 text-slate-400">🇰🇪 +254</span>
                <input 
                  type="tel" 
                  placeholder="7XX XXX XXX"
                  className="w-full pl-20 pr-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-brand-500 focus:border-brand-500 outline-none transition"
                  value={phoneNumber}
