...
export const ContactSection: React.FC = () => {
  return (
    <div className="mt-6 pt-6 border-t border-slate-200">
      <h3 className="text-xs font-bold text-slate-400 uppercase tracking-wider mb-3">Contact Support</h3>
      <div className="space-y-3">
        <div className="flex items-start gap-2">
           ...
           <div>
             ...
             <p className="text-sm font-semibold text-slate-700">0757 634590</p>
           </div>
        </div>
        ...
        <div className="flex items-start gap-2">
           ...
           <div>
             ...
             <p className="text-sm font-semibold text-slate-700">0731 176 583</p>
           </div>
        </div>
